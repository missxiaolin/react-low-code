        ...
        <>
          <Form.Item label="颜色" style={{ marginBlock: 10 }}>
            <MColorPicker
              ...
              allowClear
              value={color}
              onChange={(val: string) => handleChangeColor(val)}
            />
          </Form.Item>
          <Flex gap={10}>
            <Form.Item label="X轴">
              <InputNumber
                value={x}
                onChange={(num) => handleChange("x", num)}
                style={{ width: "100%" }}
                controls={false}
              />
            </Form.Item>
            <Form.Item label="Y轴">
              <InputNumber
                value={y}
                onChange={(num) => handleChange("y", num)}
                style={{ width: "100%" }}
                controls={false}
              />
            </Form.Item>
          ...
          <Flex gap={10}>
            <Form.Item label="模糊">
              <InputNumber
                value={blur}
                onChange={(num) => handleChange("blur", num)}
                style={{ width: "100%" }}
                controls={false}
              />
            </Form.Item>
            <Form.Item label="扩展">
              <InputNumber
                value={spread}
                onChange={(num) => handleChange("spread", num)}
                style={{ width: "100%" }}
                controls={false}
              />
            </Form.Item>
