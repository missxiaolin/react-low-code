!(function (e, t) {
  ...
  var Ae = (function () {
    ...
    Ue = (Ne && window.location.href) || "http://localhost",
    Be = s(
      s(
        {},
        Object.freeze({
  ...
  var et = function (e, t) {
    ...
    nt = Be.hasStandardBrowserEnv
      ? (function () {
          var e,
            t = Be.navigator && /(msie|trident)/i.test(Be.navigator.userAgent),
  ...
  var ut,
    ...
    ft = function (e) {
      ...
      if (
        ...
        (n.url = ke(it(n.baseURL, n.url), e.params, e.paramsSerializer)),
        c &&
          u.set(
            "Authorization",
            "Basic " +
                    ...
                    case 11:
                      ...
                      (j = new Request(n, {
                        ...
                        j.body &&
                          ...
                          (L = P[0]),
                          (N = P[1]),
                          (i = vt(j.body, 65536, L, N, bt)));
                    case 15:
                      return (
                        ve.isString(y) || (y = y ? "include" : "omit"),
                        (_ = "credentials" in Request.prototype),
                        (x = new Request(
                          n,
                          s(
                            s({}, b),
  ...
  var jt = function (e) {
    ...
    At = function (e) {
      for (
        ...
        if (
          ((r = t = e[i]),
          !kt(t) && void 0 === (r = Tt[(a = String(t)).toLowerCase()]))
        )
